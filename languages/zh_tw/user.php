...
$_LANG['booking_goods_name'] = '訂購房源名';
...
$_LANG['booking_success'] = '您的房源訂購已經成功提交！';
$_LANG['booking_rec_exist'] = '此房源您已經進行過缺貨登記了！';
$_LANG['back_booking_list'] = '返回缺貨登記列表';
$_LANG['not_dispose'] = '未處理';
$_LANG['no_goods_id'] = '請指定房源ID';

//JS語言項
$_LANG['booking_js']['booking_amount_empty'] = '請輸入您要訂購的房源數量！';
...
$_LANG['ss'][SS_SHIPPED_PART] = '已發貨(部分房源)';
...
$_LANG['del_attention'] = '確認取消此房源的關注麼？';
$_LANG['add_to_attention'] = '確定將此房源加入關注列表麼？';
$_LANG['label_need_image'] = '是否顯示房源圖片：';
$_LANG['need'] = '顯示';
$_LANG['need_not'] = '不顯示';
$_LANG['horizontal'] = '橫排';
$_LANG['verticle'] = '豎排';
$_LANG['generate'] = '生成代碼';
$_LANG['label_goods_num'] = '顯示房源數量：';
$_LANG['label_arrange'] = '選擇房源排列方式：';
...
$_LANG['goods_num_must_be_int'] = '房源數量應該是整數';
$_LANG['goods_num_must_over_0'] = '房源數量應該大於0';
...
$_LANG['return_to_cart_success'] = '訂單中房源已經成功加入購物車中';
...
　　１、在瀏覽房源時，點擊推薦此房源，獲得推薦代碼，將其發送到論壇、博客上。
　　２、訪問者點擊鏈接，訪問網店。
...
$_LANG['user_reg_info'][2] = '不註冊為會員也可在本店購買房源';
$_LANG['user_reg_info'][8] = '不註冊為會員也不可以在本店購買房源';
$_LANG['user_reg_info'][3] = '但註冊之後您可以';
$_LANG['user_reg_info'][4] = '保存您的個人資料';
$_LANG['user_reg_info'][5] = '收藏您關注的房源';
$_LANG['user_reg_info'][6] = '享受會員積分制度';
$_LANG['user_reg_info'][7] = '訂閱本店房源信息';
