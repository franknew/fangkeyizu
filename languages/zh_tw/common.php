...
$_LANG['sys_msg'] = '系統提示';
$_LANG['catalog'] = '目錄';
$_LANG['please_view_order_detail'] = '房源已發貨，詳情請到用戶中心訂單詳情查看';
...
$_LANG['promotion_goods'] = '促銷房源';
$_LANG['best_goods'] = '精品推薦';
$_LANG['new_goods'] = '新品上市';
$_LANG['hot_goods'] = '熱銷房源';
...
$_LANG['goods_number'] = '房源庫存：';
$_LANG['goods_give_integral'] = '購買此房源贈送：';
$_LANG['goods_integral'] = '購買此房源可使用：';
$_LANG['goods_free_shipping'] = '此房源為免運費房源，計算配送金額時將不計入配送費用';
$_LANG['goods_bonus'] = '購買此房源可獲得紅包：';
$_LANG['goods_rank'] = '用戶評價：';
$_LANG['goods_compare'] = '房源比較';
$_LANG['properties'] = '房源屬性：';
$_LANG['brief'] = '簡要介紹：';
$_LANG['add_time'] = '上架時間：';
...
/* 房源比較JS語言項 */
$_LANG['compare_js']['button_compare'] = '比較選定房源';
$_LANG['compare_js']['exist'] = '您已經選擇了%s';
$_LANG['compare_js']['count_limit'] = '最多只能選擇4個房源進行對比';
$_LANG['compare_js']['goods_type_different'] = '\"%s\"和已選擇房源類型不同無法進行對比';
...
$_LANG['collect_existed'] = '該房源已經存在於您的收藏夾中。';
$_LANG['collect_success'] = '該房源已經成功地加入了您的收藏夾。';
$_LANG['copyright'] = "&copy; 2005-%s %s 版權所有，並保留所有權利。";
$_LANG['no_ads_id'] = '沒有指定廣告的ID以及跳轉的URL地址!';
$_LANG['remove_collection_confirm'] = '您確定要從收藏夾中刪除選定的房源嗎？';
$_LANG['err_change_attr'] = '沒有找到指定的房源或者沒有找到指定的房源屬性。';
...
$_LANG['tag_exists'] = '您已經為該房源添加過一個標記，請不要重複提交.';
$_LANG['tag_cloud'] = '標籤雲';
$_LANG['tag_anonymous'] = '對不起，只有註冊會員並且正常登錄以後才能提交標記。';
$_LANG['tag_cloud_desc'] = '標籤雲（Tag cloud）是用以表示一個網站中的內容標籤。 標籤（tag、關鍵詞）是一種更為靈活、有趣的房源分類方式，您可以為每個房源添加一個或多個標籤，那麼可以通過點擊這個標籤查看房源其他會員提交的與您的標籤一樣的房源,能夠讓您使用最快的方式查找某一個標籤的所有網店房源。比方說點擊「紅色」這個標籤，就可以打開這樣的一個頁面，顯示所有的以「紅色」 為標籤的網店房源';

/* AJAX 相關 */
$_LANG['invalid_captcha'] = '對不起，您輸入的驗證碼不正確。';
$_LANG['goods_exists'] = '對不起，您的購物車中已經存在相同的房源。';
$_LANG['fitting_goods_exists'] = '對不起，您的購物車中已經添加了該配件。';
$_LANG['invalid_number'] = '對不起，您輸入了一個非法的房源數量。';
$_LANG['not_on_sale'] = '對不起，該房源已經下架。';
$_LANG['no_basic_goods'] = '對不起，您希望將該房源做為配件購買，可是購物車中還沒有該房源的基本件。';
$_LANG['cannt_alone_sale'] = '對不起，該房源不能單獨銷售。';
$_LANG['shortage'] = "對不起，該房源已經庫存不足暫停銷售。\n你現在要進行缺貨登記來預訂該房源嗎？";
$_LANG['shortage_little'] = "該房源已經庫存不足。已將您的購貨數量修改為 %d。\n您現在要去購物車嗎？";
$_LANG['oos_tips'] = '該房源已經庫存不足。您現在要進行缺貨登記嗎？';

$_LANG['addto_cart_success_1'] = "該房源已添加到購物車，您現在還需要繼續購物嗎？\n如果您希望馬上結算，請點擊「確定」按鈕。\n如果您希望繼續購物，請點擊「取消」按鈕。";
$_LANG['addto_cart_success_2'] = "該房源已添加到購物車，您現在還需要繼續購物嗎？\n如果您希望繼續購物，請點擊「確定」按鈕。\n如果您希望馬上結算，請點擊「取消」按鈕。";
...
$_LANG['comment_custom'] = '評論失敗。只有在本店購買過房源的註冊會員才能發表評論。';
$_LANG['comment_brought'] = '評論失敗。只有購買過此房源的註冊用戶才能評論該房源。';
$_LANG['anonymous'] = '匿名用戶';

/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '房源名不能為空！';

/* 房源比較 */
$_LANG['compare_remove'] = '移除';
$_LANG['compare_no_goods'] = '您沒有選定任何需要比較的房源或者比較的房源數少於 2 個。';
...
/* 缺貨處理 */
$_LANG['oos'][OOS_WAIT] = '等待所有房源備齊後再發';
...
/* 選購中心 */
$_LANG['pick_out'] = '選購中心';
$_LANG['fit_count'] = "共有 %s 件房源符合條件";
$_LANG['goods_type'] = "房源類型";
$_LANG['remove_all'] = '移除所有';
$_LANG['advanced_search'] = '高級搜索';
$_LANG['activity'] = '本房源正在進行';
...
$_LANG['group_buy_goods'] = '團購房源';
$_LANG['gb_goods_name'] = '團購房源：';
...
$_LANG['gb_notice_login'] = '提示：您需要先註冊成為本站會員並且登錄後，才能參加房源團購!';
$_LANG['gb_error_goods_lacking'] = '對不起，房源庫存不足，請您修改數量！';
...
$_LANG['au_bid_repeat_user'] = '您已經是這個房源的最高出價人了';
...
$_LANG['au_is_winner'] = '恭喜您，您已經贏得了該房源的購買權。請點擊下面的購買按鈕將您的寶貝買回家吧。';
...
$_LANG['wholesale'] = '批發';
$_LANG['no_wholesale'] = '沒有批發房源';
$_LANG['ws_price'] = '批發價';
$_LANG['ws_subtotal'] = '小計';
$_LANG['ws_invalid_goods_number'] = '請輸入正確的數量';
$_LANG['ws_attr_not_matching'] = '您選擇的房源屬性不存在，請參照批發價格單選擇';
$_LANG['ws_goods_number_not_enough'] = '您購買的數量沒有達到批發的最小數量，請參照批發價格單';
$_LANG['ws_goods_attr_exists'] = '該房源已經在購物車中，不能再次加入';
...
$_LANG['eg_error_status'] = '對不起，該房源已經取消，現在不能兌換！';
$_LANG['eg_error_integral'] = '對不起，您現有的積分值不夠兌換本房源！';
$_LANG['notice_eg_integral'] = '積分商城房源需要消耗積分：';
$_LANG['eg_error_number'] = '對不起，該房源庫存不足，現在不能兌換！';
...
$_LANG['topic_goods_empty'] = '當前沒有專題房源';
...
$_LANG['please_select_attr'] = '你加入購物車的房源有不同型號可選，你是否要立即跳轉到房源詳情選擇型號？';
...
$_LANG['feed_goods_price'] = "房源價格";
$_LANG['feed_goods_desc'] = "房源描述";

/* 留言板 */
$_LANG['shopman_comment'] = '房源評論';
...
$_LANG['no_history'] = '您已清空最近流覽過的房源';
$_LANG['goods_tag'] = '房源標籤';
$_LANG['releate_goods'] = '相關房源';
$_LANG['goods_list'] = '房源列表';
$_LANG['favourable_goods'] = '收藏該房源';
...
$_LANG['auction_goods'] = '拍賣房源';
$_LANG['auction_goods_info'] = '拍賣房源詳情';
...
$_LANG['wholesale_goods_cart'] = '批發房源購物車';
$_LANG['wholesale_goods_list'] = '批發房源列表';
$_LANG['bid_record'] = '出價記錄';
$_LANG['shipping_method'] = '配送方式';
$_LANG['payment_method'] = '支付方式';
$_LANG['goods_package'] = '房源包裝';
$_LANG['goods_card'] = '祝福賀卡';
$_LANG['groupbuy_intro'] = '團購說明';
$_LANG['groupbuy_goods_info'] = '團購房源詳情';
$_LANG['act_time'] = '起止時間';
$_LANG['top10'] = '銷售排行';
