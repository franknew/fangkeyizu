...
$_LANG['notice_min_goods_amount'] = '只有房源總金額達到這個數的訂單才能使用這種紅包';
...
$_LANG['send_by'][SEND_BY_GOODS] = '按房源發放';
...
$_LANG['goods_cat'] = '選擇房源分類';
$_LANG['goods_brand'] = '房源品牌';
$_LANG['goods_key'] = '房源關鍵字';
$_LANG['all_goods'] = '可選房源';
$_LANG['send_bouns_goods'] = '發放此類型紅包的房源';
$_LANG['remove_bouns'] = '移除紅包';
$_LANG['all_remove_bouns'] = '全部移除';
$_LANG['goods_already_bouns'] = '該房源已經發放過其它類型的紅包了!';
