...
$_LANG['select_method'] = '選擇房源的方式：';
$_LANG['by_cat'] = '根據房源分類、品牌';
$_LANG['by_sn'] = '根據房源貨號';
$_LANG['select_cat'] = '選擇房源分類：';
$_LANG['select_brand'] = '選擇房源品牌：';
$_LANG['goods_list'] = '房源列表：';
$_LANG['src_list'] = '待選列表：';
$_LANG['dest_list'] = '選定列表：';
$_LANG['input_sn'] = '輸入房源貨號：<br />（每行一個）';
...
$_LANG['goods_class'] = '房源類別';
$_LANG['g_class'][G_REAL] = '實體房源';
...
$_LANG['notice_file'] = '（CSV文件中一次上傳房源數量最好不要超過1000，CSV文件大小最好不要超過500K.）';
...
$_LANG['use_help'] = '使用說明：' .
        '<ol>' .
          ...
          '<li>填寫csv文件，可以使用excel或文本編輯器打開csv文件；<br />' .
              ...
              '房源圖片和房源縮略圖請填寫帶路徑的圖片文件名，其中路徑是相對於 [根目錄]/images/ 的路徑，例如圖片路徑為[根目錄]/images/200610/abc.jpg，只要填寫 200610/abc.jpg 即可；<br />' .
              '<font style="color:#FE596A;">如果是淘寶助理格式請確保cvs編碼為在網站的編碼，如編碼不正確，可以用編輯軟件轉換編碼。</font></li>' .
          '<li>將填寫的房源圖片和房源縮略圖上傳到相應目錄，例如：[根目錄]/images/200610/；</li>' .
              '<font style="color:#FE596A;">請首先上傳房源圖片和房源縮略圖再上傳csv文件，否則圖片無法處理。</font></li>' .
          '<li>選擇所上傳房源的分類以及文件編碼，上傳csv文件</li>' .
        '</ol>';

$_LANG['js_languages']['please_select_goods'] = '請您選擇房源';
$_LANG['js_languages']['please_input_sn'] = '請您輸入房源貨號';
...
// 批量上傳房源的字段
$_LANG['upload_goods']['goods_name'] = '房源名稱';
$_LANG['upload_goods']['goods_sn'] = '房源貨號';
$_LANG['upload_goods']['brand_name'] = '房源品牌';   // 需要轉換成brand_id
$_LANG['upload_goods']['market_price'] = '市場售價';
$_LANG['upload_goods']['shop_price'] = '本店售價';
$_LANG['upload_goods']['integral'] = '積分購買額度';
$_LANG['upload_goods']['original_img'] = '房源原始圖';
$_LANG['upload_goods']['goods_img'] = '房源圖片';
$_LANG['upload_goods']['goods_thumb'] = '房源縮略圖';
$_LANG['upload_goods']['keywords'] = '房源關鍵詞';
...
$_LANG['upload_goods']['is_alone_sale'] = '能否作為普通房源銷售';
$_LANG['upload_goods']['is_real'] = '是否實體房源';
