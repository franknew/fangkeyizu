...
$_LANG['template_files']['category'] = '房源分類頁模板';
$_LANG['template_files']['flow'] = '購物流程模板';
$_LANG['template_files']['goods'] = '房源詳情模板';
$_LANG['template_files']['group_buy_goods'] = '團購房源詳情模板';
$_LANG['template_files']['group_buy_list'] = '團購房源列表模板';
$_LANG['template_files']['index'] = '首頁模板';
$_LANG['template_files']['search'] = '房源搜索模板';
$_LANG['template_files']['compare'] = '房源比較模板';
$_LANG['template_files']['snatch'] = '奪寶奇兵';
$_LANG['template_files']['tag_cloud'] = '標籤雲模板';
$_LANG['template_files']['brand'] = '房源品牌頁';
...
$_LANG['template_libs']['goods_attrlinked'] = '屬性關聯的房源';
$_LANG['template_libs']['recommend_best'] = '精品推薦';
$_LANG['template_libs']['recommend_promotion'] = '促銷房源';
$_LANG['template_libs']['recommend_hot'] = '熱賣房源';
$_LANG['template_libs']['recommend_new'] = '新品上架';
$_LANG['template_libs']['bought_goods'] = '購買過此房源的人還買過的房源';
...
$_LANG['template_libs']['cat_goods'] = '分類下的房源';
$_LANG['template_libs']['category_tree'] = '房源分類樹';
...
$_LANG['template_libs']['goods_gallery'] = '房源相冊';
$_LANG['template_libs']['goods_article'] = '相關文章';
$_LANG['template_libs']['goods_list'] = '房源列表';
$_LANG['template_libs']['goods_tags'] = '房源標記';
$_LANG['template_libs']['group_buy'] = '團購房源';
$_LANG['template_libs']['group_buy_fee'] = '團購房源費用總計';
$_LANG['template_libs']['help'] = '幫助內容';
$_LANG['template_libs']['history'] = '房源瀏覽歷史';
...
$_LANG['template_libs']['goods_related'] = '相關房源';
...
$_LANG['template_libs']['auction'] = '拍賣房源';
...
$_LANG['template_libs']['categorys'] = '房源分類';
...
$_LANG['template_libs']['exchange_hot'] = '積分商城熱賣房源';
$_LANG['template_libs']['exchange_list'] = '積分商城列表房源';
