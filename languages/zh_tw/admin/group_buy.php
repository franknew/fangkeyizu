...
$_LANG['label_goods_qty'] = '房源數 / 有效房源數：';
...
/* 添加/編輯活動提交 */
$_LANG['error_goods_null'] = '您沒有選擇團購房源！';
$_LANG['error_goods_exist'] = '您選擇的房源目前有一個團購活動正在進行！';
$_LANG['error_price_ladder'] = '您沒有輸入有效的價格階梯！';
$_LANG['error_restrict_amount'] = '限購數量不能小於價格階梯中的最大數量';

$_LANG['js_languages']['error_goods_null'] = '您沒有選擇團購房源！';
...
$_LANG['js_languages']['search_is_null'] = '沒有搜索到任何房源，請重新搜索';
...
/* 操作日誌 */
$_LANG['log_action']['group_buy'] = '團購房源';
