...
$_LANG['act_ship_num'] = '此單發貨數量不能超出訂單房源數量';
$_LANG['act_good_vacancy'] = '房源已缺貨';
...
$_LANG['phone'] = '電話';
$_LANG['group_buy'] = '（團購）';
$_LANG['error_get_goods_info'] = '獲取訂單房源信息錯誤';
...
$_LANG['goods_name_brand'] = '房源名稱 [ 品牌 ]';
$_LANG['goods_sn'] = '貨號';
...
$_LANG['label_total_weight'] = '房源總重量：';

$_LANG['label_goods_amount'] = '房源總金額：';
...
$_LANG['admin'] = '管理員添加';
$_LANG['search_goods'] = '按房源編號或房源名稱或房源貨號搜索';
$_LANG['category'] = '分類';
$_LANG['brand'] = '品牌';
$_LANG['user_money_not_enough'] = '用戶餘額不足';
$_LANG['pay_points_not_enough'] = '用戶積分不足';
$_LANG['money_paid_enough'] = '已付款金額比房源總金額和各種費用之和還多，請先退款';
$_LANG['price_note'] = '備註：房源價格中已包含屬性加價';
...
$_LANG['js_languages']['confirm_drop'] = '確認要刪除該房源嗎？';
$_LANG['js_languages']['invalid_goods_number'] = '房源數量不正確';
$_LANG['js_languages']['pls_search_goods'] = '請搜索並選擇房源';
