...
$_LANG['js_languages']['move_item_confirm'] = '已選房源已經轉移到\"className\"分類下';
$_LANG['js_languages']['item_upper_limit'] = '每個分類下的房源不能超過50個';
...
$_LANG['lable_title_upload'] = '房源分類標題圖片';
