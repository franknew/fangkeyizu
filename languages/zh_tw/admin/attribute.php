...
/* 列表 */
$_LANG['by_goods_type'] = '按房源類型顯示：';
$_LANG['all_goods_type'] = '所有房源類型';
...
$_LANG['attr_type'] = '購買房源時是否需要選擇該屬性的值';
...
$_LANG['label_cat_id'] = '所屬房源類型：';
$_LANG['label_attr_index'] = '能否進行檢索：';
$_LANG['label_is_linked'] = '相同屬性值的房源是否關聯？';
$_LANG['no_index'] = '不需要檢索';
$_LANG['keywords_index'] = '關鍵字檢索';
$_LANG['range_index'] = '範圍檢索';
$_LANG['note_attr_index'] = '不需要該屬性成為檢索房源條件的情況請選擇不需要檢索，需要該屬性進行關鍵字檢索房源時選擇關鍵字檢索，如果該屬性檢索時希望是指定某個範圍時，選擇範圍檢索。';
...
$_LANG['note_attr_type'] = '選擇「單選/復選屬性」時，可以對房源該屬性設置多個值，同時還能對不同屬性值指定不同的價格加價，用戶購買房源時需要選定具體的屬性值。選擇「唯一屬性」時，房源的該屬性值只能設置一個值，用戶只能查看該值。';
