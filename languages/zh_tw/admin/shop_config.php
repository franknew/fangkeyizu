...
$_LANG['cfg_name']['image_width'] = '房源圖片寬度';
$_LANG['cfg_name']['image_height'] = '房源圖片高度';
$_LANG['cfg_name']['best_number'] = '精品推薦數量';
$_LANG['cfg_name']['new_number'] = '新品推薦數量';
$_LANG['cfg_name']['hot_number'] = '熱銷房源數量';
$_LANG['cfg_name']['promote_number'] = '特價房源的數量';
$_LANG['cfg_name']['group_goods_number'] = '團購房源的數量';
$_LANG['cfg_name']['top_number'] = '銷量排行數量';
$_LANG['cfg_name']['history_number'] = '瀏覽歷史數量';
$_LANG['cfg_name']['comments_number'] = '評論數量';
$_LANG['cfg_name']['bought_goods'] = '相關房源數量';
...
$_LANG['cfg_name']['auto_generate_gallery'] = '上傳房源是否自動生成相冊圖';
$_LANG['cfg_name']['retain_original_img'] = '上傳房源時是否保留原圖';
...
$_LANG['cfg_name']['sn_prefix'] = '房源貨號前綴';
...
$_LANG['cfg_name']['comment_factor'] = '房源評論的條件';
$_LANG['cfg_name']['no_picture'] = '房源的默認圖片';
$_LANG['cfg_name']['stats_code'] = '統計代碼';
$_LANG['cfg_name']['cache_time'] = '緩存存活時間（秒）';
$_LANG['cfg_name']['page_size'] = '房源分類頁列表的數量';
$_LANG['cfg_name']['article_page_size'] = '文章分類頁列表的數量';
$_LANG['cfg_name']['page_style'] = '分頁樣式';
$_LANG['cfg_name']['sort_order_type'] = '房源分類頁默認排序類型';
$_LANG['cfg_name']['sort_order_method'] = '房源分類頁默認排序方式';
$_LANG['cfg_name']['show_order_type'] = '房源分類頁默認顯示方式';
$_LANG['cfg_name']['goods_name_length'] = '房源名稱的長度';
$_LANG['cfg_name']['price_format'] = '房源價格顯示規則';
...
$_LANG['cfg_name']['goodsattr_style'] = '房源屬性顯示樣式';
$_LANG['cfg_name']['test_mail_address']  = '郵件地址';
$_LANG['cfg_name']['send'] = '發送測試郵件';
$_LANG['cfg_name']['send_service_email'] = '下訂單時是否給客服發郵件';
$_LANG['cfg_name']['show_goods_in_cart'] = '購物車裡顯示房源方式';
$_LANG['cfg_name']['show_attr_in_cart'] = '購物車裡是否顯示房源屬性';
...
$_LANG['cfg_name']['attr_related_number'] = '屬性關聯的房源數量';
$_LANG['cfg_name']['top10_time'] = '排行統計的時間';
$_LANG['cfg_name']['goods_gallery_number'] = '房源詳情頁相冊圖片數量';
...
$_LANG['cfg_name']['related_goods_number'] = '關聯房源顯示數量';
$_LANG['cfg_name']['visit_stats'] = '站點訪問統計';
$_LANG['cfg_name']['help_open'] = '用戶幫助是否打開';

$_LANG['cfg_desc']['smtp'] = '設置郵件服務器基本參數';
$_LANG['cfg_desc']['market_price_rate'] = '輸入房源售價時將自動根據該比例計算市場價格';
...
$_LANG['cfg_desc']['integral_percent'] = '每100元房源最多可以使用多少元積分';
$_LANG['cfg_desc']['comments_number'] = '顯示在房源詳情頁的用戶評論數量。';
...
$_LANG['cfg_desc']['bought_goods'] = '顯示多少個購買此房源的人還買過哪些房源';
$_LANG['cfg_desc']['currency_format'] = '顯示房源價格的格式，%s將被替換為相應的價格數字。';
$_LANG['cfg_desc']['image_height'] = '如果您的服務器支持GD，在您上傳房源圖片的時候將自動將圖片縮小到指定的尺寸。';
...
$_LANG['cfg_desc']['attr_related_number'] = '在房源詳情頁面顯示多少個屬性關聯的房源。';
...
$_LANG['cfg_range']['comment_factor']['3'] = '僅購買過該房源用戶';
...
$_LANG['cfg_range']['sort_order_type']['1'] = '按房源價格';
...
$_LANG['retain_original_confirm'] = "如果您不保留房源原圖，在「圖片批量處理」的時候，\\n將不會重新生成不包含原圖的房源圖片。請慎重使用該功能！";
...
$_LANG['cfg_name']['recommend_order'] = '推薦房源排序';
