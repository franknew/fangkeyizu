...
$_LANG['notice_act_name'] = '如果留空，取拍賣房源的名稱（該名稱僅用於後台，前台不會顯示）';
$_LANG['label_act_desc'] = '拍賣活動描述：';
$_LANG['label_search_goods'] = '根據房源編號、名稱或貨號搜索房源';
$_LANG['label_goods_name'] = '拍賣房源名稱：';
...
$_LANG['pls_search_goods'] = '請先搜索房源';
$_LANG['search_result_empty'] = '沒有找到房源，請重新搜索';

$_LANG['pls_select_goods'] = '請選擇拍賣房源';
$_LANG['goods_not_exist'] = '您要拍賣的房源不存在';
