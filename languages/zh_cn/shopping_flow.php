...
$_LANG['goods_not_exists'] = "对不起，指定的房源不存在";
$_LANG['drop_goods_confirm'] = "您确实要把该房源移出购物车吗？";
$_LANG['goods_number_not_int'] = "请您输入正确的房源数量。";
$_LANG['stock_insufficiency'] = "非常抱歉，您选择的房源 %s 的库存数量只有 %d，您最多只能购买 %d 件。";
...
$_LANG['no_goods_in_cart'] = "您的购物车中没有房源！";
$_LANG['not_submit_order'] = "您参与本次团购房源的订单已提交，请勿重复操作！";
...
$_LANG['goods_fittings'] = "房源相关配件";
$_LANG['parent_name'] = "相关房源：";
...
$_LANG['far_ext'][FAR_ALL] = '全部房源';
$_LANG['far_ext'][FAR_BRAND] = '以下合租方式';
$_LANG['far_ext'][FAR_CATEGORY] = '以下分类';
$_LANG['far_ext'][FAR_GOODS] = '以下房源';
...
$_LANG['goods_amount_not_enough'] = "您购买的房源没有达到本店的最低限购金额 %s ，不能提交订单。";
...
$_LANG['bonus_min_amount_error'] = "订单房源金额没有达到使用该红包的最低金额 %s";
