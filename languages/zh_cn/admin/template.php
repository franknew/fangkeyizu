...
$_LANG['template_files']['brand'] = '合租方式专区';
//$_LANG['template_files']['catalog'] = '所有分类页';
$_LANG['template_files']['category'] = '房源分类页模板';
$_LANG['template_files']['flow'] = '购物流程模板';
$_LANG['template_files']['goods'] = '房源详情模板';
$_LANG['template_files']['group_buy_goods'] = '团购房源详情模板';
$_LANG['template_files']['group_buy_list'] = '团购房源列表模板';
$_LANG['template_files']['index'] = '首页模板';
$_LANG['template_files']['search'] = '房源搜索模板';
$_LANG['template_files']['compare'] = '房源比较模板';
$_LANG['template_files']['snatch'] = '夺宝奇兵';
$_LANG['template_files']['tag_cloud'] = '标签云模板';
$_LANG['template_files']['brand'] = '合租方式页';
...
$_LANG['template_libs']['goods_attrlinked'] = '属性关联的房源';
$_LANG['template_libs']['recommend_best'] = '精品推荐';
$_LANG['template_libs']['recommend_promotion'] = '促销房源';
$_LANG['template_libs']['recommend_hot'] = '热卖房源';
$_LANG['template_libs']['recommend_new'] = '新品上架';
$_LANG['template_libs']['bought_goods'] = '购买过此房源的人还买过的房源';
$_LANG['template_libs']['bought_note_guide'] = '购买记录';
$_LANG['template_libs']['brand_goods'] = '合租方式的房源';
$_LANG['template_libs']['brands'] = '合租方式专区';
$_LANG['template_libs']['cart'] = '购物车';
$_LANG['template_libs']['cat_goods'] = '分类下的房源';
$_LANG['template_libs']['category_tree'] = '房源分类树';
...
$_LANG['template_libs']['goods_gallery'] = '房源相册';
$_LANG['template_libs']['goods_article'] = '相关文章';
$_LANG['template_libs']['goods_list'] = '房源列表';
$_LANG['template_libs']['goods_tags'] = '房源标记';
$_LANG['template_libs']['group_buy'] = '团购房源';
$_LANG['template_libs']['group_buy_fee'] = '团购房源费用总计';
$_LANG['template_libs']['help'] = '帮助内容';
$_LANG['template_libs']['history'] = '房源浏览历史';
...
$_LANG['template_libs']['goods_related'] = '相关房源';
...
$_LANG['template_libs']['auction'] = '拍卖房源';
...
$_LANG['template_libs']['categorys'] = '房源分类';
...
$_LANG['template_libs']['exchange_hot'] = '积分商城热卖房源';
$_LANG['template_libs']['exchange_list'] = '积分商城列表房源';
