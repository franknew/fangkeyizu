...
/* 房源管理 */
$_LANG['01_goods_list'] = '房源列表';
$_LANG['02_goods_add'] = '添加新房源';
$_LANG['03_category_list'] = '房源分类';
$_LANG['04_category_add'] = '添加分类';
$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '合租方式';
$_LANG['07_brand_add'] = '添加合租方式';
$_LANG['08_goods_type'] = '房源类型';
$_LANG['09_attribute_list'] = '房源属性';
$_LANG['10_attribute_add'] = '添加属性';
$_LANG['11_goods_trash'] = '房源回收站';
$_LANG['12_batch_pic'] = '图片批量处理';
$_LANG['13_batch_add'] = '房源批量上传';
$_LANG['15_batch_edit'] = '房源批量修改';
$_LANG['16_goods_script'] = '生成房源代码';
$_LANG['17_tag_manage'] = '标签管理';
$_LANG['18_product_list'] = '货品列表';
$_LANG['52_attribute_add'] = '编辑属性';
$_LANG['53_suppliers_goods'] = '供货商房源管理';

$_LANG['14_goods_export'] = '房源批量导出';

$_LANG['50_virtual_card_list'] = '虚拟房源列表';
$_LANG['51_virtual_card_add'] = '添加虚拟房源';
$_LANG['52_virtual_card_change'] = '更改加密串';
$_LANG['goods_auto'] = '房源自动上下架';
...
/* 积分兑换管理 */
$_LANG['15_exchange_goods'] = '积分商城房源';
$_LANG['15_exchange_goods_list'] = '积分商城房源列表';
$_LANG['exchange_goods_add'] = '添加新房源';
...
$_LANG['brand_name_exist'] = '已存在相同的合租方式名称!';
