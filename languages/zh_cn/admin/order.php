...
$_LANG['act_ship_num'] = '此单发货数量不能超出订单房源数量';
$_LANG['act_good_vacancy'] = '房源已缺货';
...
$_LANG['phone'] = '电话';
$_LANG['group_buy'] = '（团购）';
$_LANG['error_get_goods_info'] = '获取订单房源信息错误';
...
$_LANG['goods_info'] = '房源信息';
$_LANG['goods_name'] = '房源名称';
$_LANG['goods_name_brand'] = '房源名称 [ 合租方式 ]';
$_LANG['goods_sn'] = '货号';
...
$_LANG['label_total_weight'] = '房源总重量：';

$_LANG['label_goods_amount'] = '房源总金额：';
...
$_LANG['js_languages']['confirm_drop'] = '确认要删除该房源吗？';
$_LANG['js_languages']['invalid_goods_number'] = '房源数量不正确';
$_LANG['js_languages']['pls_search_goods'] = '请搜索并选择房源';
