...
$_LANG['cfg_name']['image_width'] = '房源图片宽度';
$_LANG['cfg_name']['image_height'] = '房源图片高度';
$_LANG['cfg_name']['best_number'] = '精品推荐数量';
$_LANG['cfg_name']['new_number'] = '新品推荐数量';
$_LANG['cfg_name']['hot_number'] = '热销房源数量';
$_LANG['cfg_name']['promote_number'] = '特价房源的数量';
$_LANG['cfg_name']['group_goods_number'] = '团购房源的数量';
$_LANG['cfg_name']['top_number'] = '销量排行数量';
$_LANG['cfg_name']['history_number'] = '浏览历史数量';
$_LANG['cfg_name']['comments_number'] = '评论数量';
$_LANG['cfg_name']['bought_goods'] = '相关房源数量';
...
$_LANG['cfg_name']['auto_generate_gallery'] = '上传房源是否自动生成相册图';
$_LANG['cfg_name']['retain_original_img'] = '上传房源时是否保留原图';
...
$_LANG['cfg_name']['sn_prefix'] = '房源货号前缀';
...
$_LANG['cfg_name']['comment_factor'] = '房源评论的条件';
$_LANG['cfg_name']['no_picture'] = '房源的默认图片';
$_LANG['cfg_name']['stats_code'] = '统计代码';
$_LANG['cfg_name']['cache_time'] = '缓存存活时间（秒）';
$_LANG['cfg_name']['page_size'] = '房源分类页列表的数量';
$_LANG['cfg_name']['article_page_size'] = '文章分类页列表的数量';
$_LANG['cfg_name']['page_style'] = '分页样式';
$_LANG['cfg_name']['sort_order_type'] = '房源分类页默认排序类型';
$_LANG['cfg_name']['sort_order_method'] = '房源分类页默认排序方式';
$_LANG['cfg_name']['show_order_type'] = '房源分类页默认显示方式';
$_LANG['cfg_name']['goods_name_length'] = '房源名称的长度';
$_LANG['cfg_name']['price_format'] = '房源价格显示规则';
...
$_LANG['cfg_name']['show_brand'] = '是否显示合租方式';
...
$_LANG['cfg_name']['goodsattr_style'] = '房源属性显示样式';
$_LANG['cfg_name']['test_mail_address']  = '邮件地址';
$_LANG['cfg_name']['send'] = '发送测试邮件';
$_LANG['cfg_name']['send_service_email'] = '下订单时是否给客服发邮件';
$_LANG['cfg_name']['show_goods_in_cart'] = '购物车里显示房源方式';
$_LANG['cfg_name']['show_attr_in_cart'] = '购物车里是否显示房源属性';
...
$_LANG['cfg_name']['attr_related_number'] = '属性关联的房源数量';
$_LANG['cfg_name']['top10_time'] = '排行统计的时间';
$_LANG['cfg_name']['goods_gallery_number'] = '房源详情页相册图片数量';
...
$_LANG['cfg_name']['related_goods_number'] = '关联房源显示数量';
$_LANG['cfg_name']['visit_stats'] = '站点访问统计';
$_LANG['cfg_name']['help_open'] = '用户帮助是否打开';

$_LANG['cfg_desc']['smtp'] = '设置邮件服务器基本参数';
$_LANG['cfg_desc']['market_price_rate'] = '输入房源售价时将自动根据该比例计算市场价格';
...
$_LANG['cfg_desc']['integral_percent'] = '每100元房源最多可以使用多少元积分';
$_LANG['cfg_desc']['comments_number'] = '显示在房源详情页的用户评论数量。';
...
$_LANG['cfg_desc']['bought_goods'] = '显示多少个购买此房源的人还买过哪些房源';
$_LANG['cfg_desc']['currency_format'] = '显示房源价格的格式，%s将被替换为相应的价格数字。';
$_LANG['cfg_desc']['image_height'] = '如果您的服务器支持GD，在您上传房源图片的时候将自动将图片缩小到指定的尺寸。';
...
$_LANG['cfg_desc']['attr_related_number'] = '在房源详情页面显示多少个属性关联的房源。';
...
$_LANG['cfg_range']['comment_factor']['3'] = '仅购买过该房源用户';
...
$_LANG['cfg_range']['sort_order_type']['1'] = '按房源价格';
...
$_LANG['retain_original_confirm'] = "如果您不保留房源原图，在“图片批量处理”的时候，\\n将不会重新生成不包含原图的房源图片。请慎重使用该功能！";
...
$_LANG['cfg_name']['recommend_order'] = '推荐房源排序';
