...
$_LANG['save_wholesale_falid'] = '部分规格房源在房源“%s”的货品表中不存在，无法全部保存';
...
/* info */
$_LANG['label_search_goods'] = '房源编号、名称或货号';
$_LANG['label_goods_name'] = '批发房源名称：';
$_LANG['label_rank_name'] = '适用会员等级：';
$_LANG['label_enabled'] = '是否启用：';
$_LANG['js_languages']['pls_search_goods'] = '请搜索并选择批发房源';
$_LANG['pls_search_goods'] = '请先搜索房源';
$_LANG['search_result_empty'] = '没有找到房源，请重新搜索';
$_LANG['quantity'] = '数量';
$_LANG['price'] = '价格';
...
$_LANG['user_rank_exist'] = '已经存在该房源针对您选择的会员等级的批发方案了';
