...
$_LANG['goods_stat'] = '实体房源统计信息';
$_LANG['virtual_card_stat'] = '虚拟卡房源统计';
$_LANG['goods_count'] = '房源总数:';
$_LANG['sales_count'] = '促销房源数:';
$_LANG['new_goods'] = '新品推荐数:';
$_LANG['recommed_goods'] = '精品推荐数:';
$_LANG['hot_goods'] = '热销房源数:';
$_LANG['warn_goods'] = '库存警告房源数:';
...
$_LANG['data_cannt_write'] = '您将无法上传包装、贺卡、合租方式等等图片文件。';
$_LANG['afficheimg_cannt_write'] = '您将无法上传广告的图片文件。';
$_LANG['brandlogo_cannt_write'] = '您将无法上传合租方式的图片文件。';
...
$_LANG['images_cannt_write']= '您将无法上传任何房源图片。';
...
$_LANG['good_name'] = '房源名称';
$_LANG['good_number'] = '房源数量';
$_LANG['good_category'] = '房源分类';
$_LANG['good_brand'] = '合租方式';
$_LANG['good_price'] = '房源价格';
$_LANG['good_brief'] = '房源描述';
$_LANG['good_image'] = '上传房源图片';
$_LANG['is_new'] = '新品';
$_LANG['is_best'] = '精品';
$_LANG['is_hot'] = '热卖';
...
$_LANG['js_languages']['good_name_not_null'] = '房源名称不能为空';
$_LANG['js_languages']['good_category_not_null'] = '房源分类不能为空';
$_LANG['js_languages']['good_number_not_number'] = '房源数量不是数值';
$_LANG['js_languages']['good_price_not_number'] = '房源价格不是数值';
