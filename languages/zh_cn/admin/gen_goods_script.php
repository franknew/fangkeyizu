 ...
 */
$_LANG['label_category'] = '选择房源分类：';
$_LANG['label_brand'] = '选择合租方式：';
...
$_LANG['js_languages']['goods_num_must_be_int'] = '房源数量应该是整数';
$_LANG['js_languages']['goods_num_must_over_0'] = '房源数量应该大于0';
