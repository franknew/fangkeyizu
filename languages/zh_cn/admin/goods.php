...
$_LANG['lab_is_free_shipping'] = '是否为免运费房源';

$_LANG['compute_by_mp'] = '按市场价计算';

$_LANG['notice_goods_sn'] = '如果您不输入房源货号，系统将自动生成一个唯一的货号。';
$_LANG['notice_integral'] = '(此处需填写金额)购买该房源时最多可以使用积分的金额';
...
$_LANG['notice_storage'] = '库存在房源为虚货或房源存在货品时为不可编辑状态，库存数值取决于其虚货数量或货品数量';
...
$_LANG['free_shipping'] = '打勾表示此房源不会产生运费花销，否则按照正常运费计算。';
...
$_LANG['rapid_add_brand'] = '添加合租方式';
$_LANG['category_manage'] = '分类管理';
$_LANG['brand_manage'] = '合租方式管理';
$_LANG['hide'] = '隐藏';
...
$_LANG['suppliers_no']             = '不指定供货商属于本店房源';
...
$_LANG['js_languages']['brand_cat_not_null'] = '合租方式名称不能为空';
...
$_LANG['js_languages']['go_brand_page'] = '本页数据将丢失，确认要去合租方式页添加合租方式吗？';
...
$_LANG['products_title'] = '房源名称：%s';
$_LANG['products_title_2'] = '货号：%s';
$_LANG['good_shop_price'] = '（房源价格：%d）';
$_LANG['good_goods_sn'] = '（房源货号：%s）';
...
$_LANG['cannot_goods_number'] = '此房源存在货品，不能修改房源库存';
$_LANG['not_exist_goods_attr'] = '此房源不存在规格，请为其添加规格';
$_LANG['goods_sn_exists'] = '您输入的货号已存在，请换一个';
?>