...
; (function ($) {
    ...
    var defaults = {
        ...
        onSliderGoto: function (index) { return true }
    };
    ...
    $.fn.bxSlider = function (options) {
        ...
        var setup = function () {
            ...
            slider.loader = $('<div class="bx-loading" style="display:none" />');
            ...
            slider.viewport.parent().css({
                maxWidth: slider.settings.slideWidt
            });
        ...
        var getViewportHeight = function () {
            ...
            if (slider.viewport.css('box-sizing') === 'border-box') {
                var topHeight = 0;
                var bottomHeight = 0;
                var borderTopHeight = 0;
                var borderBottomHeight = 0;
                if (slider.viewport.hasClass("padding-top")) {
                    topHeight = parseFloat(slider.viewport.css('padding-top'));
                }
                if (slider.viewport.hasClass("padding-bottom")) {
                    bottomHeight = parseFloat(slider.viewport.css('padding-bottom'));
                }
                if (slider.viewport.hasClass("border-top-width")) {
                    borderTopHeight = parseFloat(slider.viewport.css('border-top-width'));
                }
                if (slider.viewport.hasClass("border-bottom-width")) {
                    borderBottomHeight = parseFloat(slider.viewport.css('border-bottom-width'));
                }
                height += topHeight + bottomHeight +
							borderBottomHeight + borderTopHeight;
        ...
        el.goToSlide = function (slideIndex, direction) {
            ...
            if (slider.settings.mode === 'fade') {
                ...
                if (slider.settings.onSliderGoto != null) {
                    slider.settings.onSliderGoto(slideIndex);
                }
                el.startAuto(true);
                el.startAuto(true);
            }
