...
$_LANG['category_edit'] = '編輯房源分類';
$_LANG['move_goods'] = '轉移房源';
$_LANG['cat_top'] = '頂級分類';
$_LANG['show_in_nav'] = '是否顯示在導航欄';
$_LANG['cat_style'] = '分類的樣式表文件';
$_LANG['is_show'] = '是否顯示';
$_LANG['show_in_index'] = '設置為首頁推薦';
$_LANG['notice_show_in_index'] = '該設置可以在首頁的最新、熱門、推薦處顯示該分類下的推薦房源';
$_LANG['goods_number'] = '房源數量';
$_LANG['grade'] = '價格區間個數';
$_LANG['notice_grade'] = '該選項表示該分類下房源最低價與最高價之間的劃分的等級個數，填0表示不做分級，最多不能超過10個。';
...
$_LANG['notice_style'] = '您可以為每一個房源分類指定一個樣式表文件。例如文件存放在 themes 目錄下則輸入：themes/style.css';

/* 操作提示信息 */
$_LANG['catname_empty'] = '分類名稱不能為空!';
$_LANG['catname_exist'] = '已存在相同的分類名稱!';
$_LANG["parent_isleaf"] = '所選分類不能是末級分類!';
$_LANG["cat_isleaf"] = '不是末級分類或者此分類下還存在有房源,您不能刪除!';
$_LANG["cat_noleaf"] = '底下還有其它子分類,不能修改為末級分類!';
$_LANG["is_leaf_error"] = '所選擇的上級分類不能是當前分類或者當前分類的下級分類!';
$_LANG['grade_error'] = '價格分級數量只能是0-10之內的整數';

$_LANG['catadd_succed'] = '新房源分類添加成功!';
$_LANG['catedit_succed'] = '房源分類編輯成功!';
$_LANG['catdrop_succed'] = '房源分類刪除成功!';
$_LANG['catremove_succed'] = '房源分類轉移成功!';
$_LANG['move_cat_success'] = '轉移房源分類已成功完成!';

$_LANG['cat_move_desc'] = '什麼是轉移房源分類?';
...
$_LANG['cat_move_notic'] = '在添加房源或者在房源管理中,如果需要對房源的分類進行變更,那麼你可以通過此功能,正確管理你的房源分類。';

$_LANG['cat_move_empty'] = '你沒有正確選擇房源分類!';

$_LANG['sel_goods_type'] = '請選擇房源類型';
$_LANG['sel_filter_attr'] = '請選擇篩選屬性';
$_LANG['filter_attr'] = '篩選屬性';
$_LANG['filter_attr_notic'] = '篩選屬性可在前分類頁面篩選房源';
