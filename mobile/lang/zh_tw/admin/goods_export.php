...
$_LANG['ecshop']['goods_name'] = '房源名稱';
$_LANG['ecshop']['goods_sn'] = '房源貨號';
$_LANG['ecshop']['brand_name'] = '房源品牌';   // 需要轉換成brand_id
$_LANG['ecshop']['market_price'] = '市場售價';
$_LANG['ecshop']['shop_price'] = '本店售價';
$_LANG['ecshop']['integral'] = '積分購買額度';
$_LANG['ecshop']['original_img'] = '房源原始圖';
$_LANG['ecshop']['goods_img'] = '房源圖片';
$_LANG['ecshop']['goods_thumb'] = '房源縮略圖';
$_LANG['ecshop']['keywords'] = '房源關鍵詞';
...
$_LANG['ecshop']['is_alone_sale'] = '能否作為普通房源銷售';
$_LANG['ecshop']['is_real'] = '是否實體房源';

//自定義導出數據格式
$_LANG['export_custom'] = '導出到自定義數據格式';
$_LANG['custom']['goods_name'] = '房源名稱';
$_LANG['custom']['goods_sn'] = '房源貨號';
$_LANG['custom']['brand_name'] = '房源品牌';
$_LANG['custom']['market_price'] = '市場售價';
$_LANG['custom']['shop_price'] = '本店售價';
$_LANG['custom']['integral'] = '積分購買額度';
$_LANG['custom']['original_img'] = '房源原始圖';
$_LANG['custom']['goods_img'] = '房源圖片';
$_LANG['custom']['goods_thumb'] = '房源縮略圖';
$_LANG['custom']['keywords'] = '房源關鍵詞';
...
$_LANG['custom']['is_alone_sale'] = '能否作為普通房源銷售';
$_LANG['custom']['is_real'] = '是否實體房源';

$_LANG['custom_keyword'] = '關鍵字';
$_LANG['custom_goods_cat'] = '所有分類';
$_LANG['custom_goods_brand'] = '所有品牌';
$_LANG['custom_goods_list'] = '選擇房源數據列';
$_LANG['custom_goods_type'] = '所有房源類型';
$_LANG['custom_export_list'] = '輸出房源數據列';
$_LANG['custom_up'] = '上';
$_LANG['custom_down'] = '下';
$_LANG['custom_goods_search'] = '導出條件';
$_LANG['custom_goods_field_not_null'] = '輸出的房源數據列不能為空';

// 導出條件
$_LANG['export_condition'] = '房源數據批量導出';
