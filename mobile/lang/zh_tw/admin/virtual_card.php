...
//-- 卡片信息
/*------------------------------------------------------ */
$_LANG['virtual_card_list'] = '虛擬卡房源列表';
...
/* 提示信息 */
$_LANG['replenish_no_goods_id'] = '缺少房源ID參數，無法進行補貨操作';
$_LANG['replenish_no_get_goods_name'] = '房源ID參數有誤，無法獲取房源名';
