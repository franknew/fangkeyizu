...
//房源管理部分的權限
$_LANG['goods_manage'] = '房源添加/編輯';
$_LANG['remove_back'] = '房源刪除/恢復';
$_LANG['cat_manage'] = '分類添加/編輯';
$_LANG['cat_drop'] = '分類轉移/刪除';
$_LANG['attr_manage'] = '房源屬性管理';
...
$_LANG['goods_export'] = '房源批量導出';
$_LANG['goods_batch'] = '房源批量上傳/修改';
$_LANG['gen_goods_script'] = '生成房源代碼';
