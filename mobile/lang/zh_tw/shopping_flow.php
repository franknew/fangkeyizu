...
$_LANG['goods_not_exists'] = '對不起，指定的房源不存在';
$_LANG['drop_goods_confirm'] = '您確實要把該房源移出購物車嗎？';
$_LANG['goods_number_not_int'] = '請您輸入正確的房源數量。';
$_LANG['stock_insufficiency'] = '非常抱歉，您選擇的房源 %s 的庫存數量只有 %d，您最多只能購買 %d 件。';
...
$_LANG['no_goods_in_cart'] = '您的購物車中沒有房源！';
$_LANG['not_submit_order'] = '您參與本次團購房源的訂單已提交，請勿重複操作！';
...
$_LANG['no'] = '無';
$_LANG['not_support_virtual_goods'] = '購物車中存在非實體房源,不支持匿名購買,請登陸後在購買';
...
$_LANG['goods_fittings'] = '房源相關配件';
$_LANG['parent_name'] = '相關房源：';
...
$_LANG['goods_amount_not_enough'] = '您購買的房源沒有達到本店的最低限購金額 %s ，不能提交訂單。';
...
$_LANG['bonus_min_amount_error'] = '訂單房源金額沒有達到使用該紅包的最低金額 %s';
