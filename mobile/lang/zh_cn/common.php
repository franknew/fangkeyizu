...
$_LANG['sys_msg'] = '系统提示';
$_LANG['catalog'] = '目录';
$_LANG['please_view_order_detail'] = '房源已发货，详情请到用户中心订单详情查看';
...
$_LANG['kilogram'] = '千克';
$_LANG['goods_sn'] = '房源货号：';
$_LANG['goods_brand'] = '房源品牌：';
$_LANG['goods_weight'] = '房源重量：';
$_LANG['goods_number'] = '房源库存：';
$_LANG['goods_give_integral'] = '购买此房源赠送：';
$_LANG['goods_integral'] = '购买此房源可使用：';
$_LANG['goods_bonus'] = '购买此房源可获得红包：';
$_LANG['goods_free_shipping'] = '此房源为免运费房源，计算配送金额时将不计入配送费用';
$_LANG['goods_rank'] = '用户评价：';
$_LANG['goods_compare'] = '房源比较';
$_LANG['properties'] = '房源属性：';
$_LANG['brief'] = '简要介绍：';
$_LANG['add_time'] = '上架时间：';
...
$_LANG['minute'] = '分钟';
$_LANG['compare'] = '比较';
$_LANG['volume_price'] = '购买房源达到以下数量区间时可享受的优惠价格';
$_LANG['number_to'] = '数量';
$_LANG['article_list'] = '文章列表';


/* 房源比较JS语言项 */
$_LANG['compare_js']['button_compare'] = '比较选定房源';
$_LANG['compare_js']['exist'] = '您已经选择了%s';
$_LANG['compare_js']['count_limit'] = '最多只能选择4个房源进行对比';
$_LANG['compare_js']['goods_type_different'] = '\"%s\"和已选择房源类型不同无法进行对比';
...
$_LANG['collect_existed'] = '该房源已经存在于您的收藏夹中。';
$_LANG['collect_success'] = '该房源已经成功地加入了您的收藏夹。';
$_LANG['copyright'] = "&copy; 2005-%s %s 版权所有，并保留所有权利。";
$_LANG['no_ads_id'] = '没有指定广告的ID以及跳转的URL地址!';
$_LANG['remove_collection_confirm'] = '您确定要从收藏夹中删除选定的房源吗？';
$_LANG['err_change_attr'] = '没有找到指定的房源或者没有找到指定的房源属性。';

$_LANG['collect_goods'] = '收藏房源';
$_LANG['plus'] = '加';
$_LANG['minus'] = '减';
$_LANG['yes'] = '是';
$_LANG['no'] = '否';

$_LANG['same_attrbiute_goods'] = '相同%s的房源';

/* TAG */
$_LANG['button_submit_tag'] = '添加我的标记';
$_LANG['tag_exists'] = '您已经为该房源添加过一个标记，请不要重复提交.';
$_LANG['tag_cloud'] = '标签云';
$_LANG['tag_anonymous'] = '对不起，只有注册会员并且正常登录以后才能提交标记。';
$_LANG['tag_cloud_desc'] = '标签云（Tag cloud）是用以表示一个网站中的内容标签。 标签（tag、关键词）是一种更为灵活、有趣的房源分类方式，您可以为每个房源添加一个或多个标签，那么可以通过点击这个标签查看房源其他会员提交的与您的标签一样的房源,能够让您使用最快的方式查找某一个标签的所有网店房源。比方说点击“红色”这个标签，就可以打开这样的一个页面，显示所有的以“红色” 为标签的网店房源';

/* AJAX 相关 */
$_LANG['invalid_captcha'] = '对不起，您输入的验证码不正确。';
$_LANG['goods_exists'] = '对不起，您的购物车中已经存在相同的房源。';
$_LANG['fitting_goods_exists'] = '对不起，您的购物车中已经添加了该配件。';
$_LANG['invalid_number'] = '对不起，您输入了一个非法的房源数量。';
$_LANG['not_on_sale'] = '对不起，该房源已经下架。';
$_LANG['no_basic_goods'] = '对不起，您希望将该房源做为配件购买，可是购物车中还没有该房源的基本件。';
$_LANG['cannt_alone_sale'] = '对不起，该房源不能单独销售。';
$_LANG['shortage'] = "该房源已经库存不足暂停销售。";
$_LANG['shortage_little'] = "该房源已经库存不足。已将您的购货数量修改为 %d。\n您现在要去购物车吗？";
$_LANG['oos_tips'] = '该房源已经库存不足。';

$_LANG['addto_cart_success_1'] = "该房源已添加到购物车，您现在还需要继续购物吗？\n如果您希望马上结算，请点击“确定”按钮。\n如果您希望继续购物，请点击“取消”按钮。";
$_LANG['addto_cart_success_2'] = "该房源已添加到购物车，您现在还需要继续购物吗？\n如果您希望继续购物，请点击“确定”按钮。\n如果您希望马上结算，请点击“取消”按钮。";
...
$_LANG['comment_custom'] = '评论失败。只有在本店购买过房源的注册会员才能发表评论。';
$_LANG['comment_brought'] = '评论失败。只有购买过此房源的注册用户才能评论该房源。';
$_LANG['anonymous'] = '匿名用户';

/* 其他信息 */
$_LANG['js_languages']['goodsname_not_null'] = '房源名不能为空！';

/* 房源比较 */
$_LANG['compare_remove'] = '移除';
$_LANG['compare_no_goods'] = '您没有选定任何需要比较的房源或者比较的房源数少于 2 个。';
...
/* 缺货处理 */
$_LANG['oos'][OOS_WAIT] = '等待所有房源备齐后再发';
...
/* 选购中心 */
$_LANG['pick_out'] = '选购中心';
$_LANG['fit_count'] = "共有 %s 件房源符合条件";
$_LANG['goods_type'] = "房源类型";
$_LANG['remove_all'] = '移除所有';
$_LANG['advanced_search'] = '高级搜索';
$_LANG['activity'] = '本房源正在进行';
...
$_LANG['group_buy_goods'] = '团购房源';
$_LANG['gb_goods_name'] = '团购房源：';
...
$_LANG['gb_notice_login'] = '提示：您需要先注册成为本站会员并且登录后，才能参加房源团购!';
$_LANG['gb_error_goods_lacking'] = '对不起，房源库存不足，请您修改数量！';
...
$_LANG['au_bid_repeat_user'] = '您已经是这个房源的最高出价人了';
...
$_LANG['au_is_winner'] = '恭喜您，您已经赢得了该房源的购买权。请点击下面的购买按钮将您的宝贝买回家吧。';
...
$_LANG['wholesale'] = '批发';
$_LANG['no_wholesale'] = '没有批发房源';
$_LANG['ws_price'] = '批发价';
$_LANG['ws_subtotal'] = '小计';
$_LANG['ws_invalid_goods_number'] = '请输入正确的数量';
$_LANG['ws_attr_not_matching'] = '您选择的房源属性不存在，请参照批发价格单选择';
$_LANG['ws_goods_number_not_enough'] = '您购买的数量没有达到批发的最小数量，请参照批发价格单';
$_LANG['ws_goods_attr_exists'] = '该房源已经在购物车中，不能再次加入';
...
$_LANG['eg_error_status'] = '对不起，该房源已经取消，现在不能兑换！';
$_LANG['eg_error_integral'] = '对不起，您现有的积分值不够兑换本房源！';
$_LANG['notice_eg_integral'] = '积分商城房源需要消耗积分：';
$_LANG['eg_error_number'] = '对不起，该房源库存不足，现在不能兑换！';
...
$_LANG['topic_goods_empty'] = '当前没有专题房源';
...
$_LANG['please_select_attr'] = '你加入购物车的房源有不同型号可选，你是否要立即跳转到房源详情选择型号？';
...
$_LANG['feed_goods_price'] = "房源价格";
$_LANG['feed_goods_desc'] = "房源描述";

/* 留言板 */
$_LANG['shopman_comment'] = '房源评论';
...
$_LANG['no_history'] = '您已清空最近浏览过的房源';
$_LANG['goods_tag'] = '房源标签';
$_LANG['releate_goods'] = '相关房源';
$_LANG['goods_list'] = '房源列表';
$_LANG['favourable_goods'] = '收藏该房源';
...
$_LANG['auction_goods'] = '拍卖房源';
$_LANG['auction_goods_info'] = '拍卖房源详情';
...
$_LANG['wholesale_goods_cart'] = '批发房源购物车';
$_LANG['wholesale_goods_list'] = '批发房源列表';
$_LANG['bid_record'] = '出价记录';
$_LANG['shipping_method'] = '配送方式';
$_LANG['payment_method'] = '支付方式';
$_LANG['goods_package'] = '房源包装';
$_LANG['goods_card'] = '祝福贺卡';
$_LANG['groupbuy_intro'] = '团购说明';
$_LANG['groupbuy_goods_info'] = '团购房源详情';
$_LANG['act_time'] = '起止时间';
$_LANG['top10'] = '销售排行';
