...
$_LANG['booking_goods_name'] = '订购房源名';
...
$_LANG['booking_success'] = '您的房源订购已经成功提交！';
$_LANG['booking_rec_exist'] = '此房源您已经进行过缺货登记了！';
$_LANG['back_booking_list'] = '返回缺货登记列表';
$_LANG['not_dispose'] = '未处理';
$_LANG['no_goods_id'] = '请指定房源ID';

//JS语言项
$_LANG['booking_js']['booking_amount_empty'] = '请输入您要订购的房源数量！';
...
$_LANG['ss'][SS_SHIPPED_PART] = '已发货(部分房源)';
...
$_LANG['del_attention'] = '确认取消此房源的关注么？';
$_LANG['add_to_attention'] = '确定将此房源加入关注列表么？';
$_LANG['label_need_image'] = '是否显示房源图片：';
$_LANG['need'] = '显示';
$_LANG['need_not'] = '不显示';
$_LANG['horizontal'] = '横排';
$_LANG['verticle'] = '竖排';
$_LANG['generate'] = '生成代码';
$_LANG['label_goods_num'] = '显示房源数量：';
$_LANG['label_rows_num'] = '排列显示条目数：';
$_LANG['label_arrange'] = '选择房源排列方式：';
$_LANG['label_charset'] = '选择编码：';
$_LANG['charset']['utf8'] = '国际化编码（utf8）';
$_LANG['charset']['zh_cn'] = '简体中文';
$_LANG['charset']['zh_tw'] = '繁体中文';
$_LANG['goods_num_must_be_int'] = '房源数量应该是整数';
$_LANG['goods_num_must_over_0'] = '房源数量应该大于0';
...
$_LANG['return_to_cart_success'] = '订单中房源已经成功加入购物车中';
...
　　１、在浏览房源时，点击推荐此房源，获得推荐代码，将其发送到论坛、博客、微信上。
　　２、访问者点击链接，访问微卖商城。
...
$_LANG['user_reg_info'][2] = '不注册为会员也可在本店购买房源';
$_LANG['user_reg_info'][8] = '不注册为会员不可以在本店购买房源';
$_LANG['user_reg_info'][3] = '但注册之后您可以';
$_LANG['user_reg_info'][4] = '保存您的个人资料';
$_LANG['user_reg_info'][5] = '收藏您关注的房源';
$_LANG['user_reg_info'][6] = '享受会员积分制度';
$_LANG['user_reg_info'][7] = '订阅本店房源信息';
