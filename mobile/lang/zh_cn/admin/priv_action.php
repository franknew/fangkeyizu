...
//房源管理部分的权限
$_LANG['goods_manage'] = '房源添加/编辑';
$_LANG['remove_back'] = '房源删除/恢复';
$_LANG['cat_manage'] = '分类添加/编辑';
$_LANG['cat_drop'] = '分类转移/删除';
$_LANG['attr_manage'] = '房源属性管理';
$_LANG['brand_manage'] = '房源品牌管理';
...
$_LANG['goods_export'] = '房源批量导出';
$_LANG['goods_batch'] = '房源批量上传/修改';
$_LANG['gen_goods_script'] = '生成房源代码';
$_LANG['suppliers_goods'] = '供货商房源管理';
