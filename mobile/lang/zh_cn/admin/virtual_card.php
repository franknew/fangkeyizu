...
//-- 卡片信息
/*------------------------------------------------------ */
$_LANG['virtual_card_list'] = '虚拟房源列表';
...
/* 提示信息 */
$_LANG['replenish_no_goods_id'] = '缺少房源ID参数，无法进行补货操作';
$_LANG['replenish_no_get_goods_name'] = '房源ID参数有误，无法获取房源名';
