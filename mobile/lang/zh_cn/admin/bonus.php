...
$_LANG['notice_min_goods_amount'] = '只有房源总金额达到这个数的订单才能使用这种红包';
...
$_LANG['send_by'][SEND_BY_GOODS] = '按房源发放';
...
$_LANG['goods_cat'] = '选择房源分类';
$_LANG['goods_brand'] = '房源品牌';
$_LANG['goods_key'] = '房源关键字';
$_LANG['all_goods'] = '可选房源';
$_LANG['send_bouns_goods'] = '发放此类型红包的房源';
$_LANG['remove_bouns'] = '移除红包';
$_LANG['all_remove_bouns'] = '全部移除';
$_LANG['goods_already_bouns'] = '该房源已经发放过其它类型的红包了!';
