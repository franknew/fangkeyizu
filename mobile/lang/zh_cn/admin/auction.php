...
$_LANG['notice_act_name'] = '如果留空，取拍卖房源的名称（该名称仅用于后台，前台不会显示）';
$_LANG['label_act_desc'] = '拍卖活动描述：';
$_LANG['label_search_goods'] = '根据房源编号、名称或货号搜索房源';
$_LANG['label_goods_name'] = '拍卖房源名称：';
...
$_LANG['pls_select_goods'] = '请选择拍卖房源';
$_LANG['goods_not_exist'] = '您要拍卖的房源不存在';
