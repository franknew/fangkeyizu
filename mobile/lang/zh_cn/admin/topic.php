...
$_LANG['js_languages']['move_item_confirm'] = '已选房源已经转移到\"className\"分类下';
$_LANG['js_languages']['item_upper_limit'] = '每个分类下的房源不能超过50个';
...
$_LANG['lable_title_upload'] = '房源分类标题图片';
