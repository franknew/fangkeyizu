...
<section class="wrap">
  <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;"> <a href="user.php?act=profile" class="clearfix"> <span><?php echo $this->_var['lang']['label_profile']; ?></span><i></i> </a>  <a href="user.php?act=collection_list"  class="clearfix"> <span><?php echo $this->_var['lang']['label_collection']; ?></span><i></i> </a> </div>
  <div class="blank3"></div>
  <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;"> <a href="user.php?act=message_list" class="clearfix"> <span><?php echo $this->_var['lang']['label_message']; ?></span><i></i> </a></div>
  <div class="blank3"></div>
...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/default/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
