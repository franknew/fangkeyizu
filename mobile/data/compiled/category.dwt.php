...
?>
		...
		<ul class="show_box" >
         <li><?php if ($this->_var['cat']['id'] == $this->_var['category']): ?><span><?php endif; ?><a href="<?php echo $this->_var['cat']['url']; ?>">全部</a><?php if ($this->_var['cat']['id'] == $this->_var['category']): ?></span><?php endif; ?></li>
		 <?php $_from = $this->_var['cat']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child');if (count($_from)):
    foreach ($_from AS $this->_var['child']):
?>
         <li><?php if ($this->_var['child']['id'] == $this->_var['category']): ?><span><?php endif; ?><a href="<?php echo $this->_var['child']['url']; ?>" ><?php echo htmlspecialchars($this->_var['child']['name']); ?></a><?php if ($this->_var['child']['id'] == $this->_var['category']): ?></span><?php endif; ?></li>

         <?php $_from = $this->_var['child']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'childer');if (count($_from)):
    foreach ($_from AS $this->_var['childer']):
?>
		<li><span><a href="<?php echo $this->_var['childer']['url']; ?>" ><?php echo htmlspecialchars($this->_var['childer']['name']); ?></a></span></li>
    ...
    <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_70035400_1438665537');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_70035400_1438665537']):
?>
    <div class="screeBox clearfix"> <strong><?php echo htmlspecialchars($this->_var['filter_attr_0_70035400_1438665537']['filter_attr_name']); ?>：</strong>
      <ul class="show_box" >
        <?php $_from = $this->_var['filter_attr_0_70035400_1438665537']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
...
?> 
      ...
      <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_70163000_1438665537');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_70163000_1438665537']):
?>
      <div class="attr brandAttr">
        <div class="attrKey"><?php echo htmlspecialchars($this->_var['filter_attr_0_70163000_1438665537']['filter_attr_name']); ?></div>
        <div class="attrValues">
          <ul class="av-collapse filter_list">
            <?php $_from = $this->_var['filter_attr_0_70163000_1438665537']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
    foreach ($_from AS $this->_var['attr']):
?> 
            <?php if ($this->_var['attr']['selected']): ?>
