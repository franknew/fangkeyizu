...
<div id="page">
  <header id="header" >
    ...
    <h1><img src="themes/default/images/logo.png" width="30" height="30" style="vertical-align:top"> <?php echo $this->_var['shop_name']; ?></a> </h1>
    ...
    <div class=content>
      <div id=fake-search>
        <div class="fakeInput box1 radius15">
          <button class="text" id="get_search_box" style="color:silver;">搜房源</button>
