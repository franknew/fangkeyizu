<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:66:"/www/web/fangkeyizu/public_html/mobile/themes/default/category.dwt";i:1;s:76:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/goods_list.lbi";i:2;s:77:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1438932673;s:8:"maketime";i:1438929073;}<!DOCTYPE html>
<html>
<head>
...
<div class="search_rightChoseAll clearfix  ">
  ...
  <div class="searchRight_brand "> 
      ...
      <ul class="show_box"  >
                ...
                <li><a href="category.php?id=18&amp;price_min=1800&amp;price_max=3000&amp;filter_attr=0.0.0">1800&nbsp;-&nbsp;3000</a></li>
         
         
                <li><a href="category.php?id=18&amp;price_min=3000&amp;price_max=4200&amp;filter_attr=0.0.0">3000&nbsp;-&nbsp;4200</a></li>
         
         
                <li><a href="category.php?id=18&amp;price_min=4200&amp;price_max=5400&amp;filter_attr=0.0.0">4200&nbsp;-&nbsp;5400</a></li>
         
         
                <li><a href="category.php?id=18&amp;price_min=5400&amp;price_max=6600&amp;filter_attr=0.0.0">5400&nbsp;-&nbsp;6600</a></li>
         
         
                <li><a href="category.php?id=18&amp;price_min=6600&amp;price_max=7800&amp;filter_attr=0.0.0">6600&nbsp;-&nbsp;7800</a></li>
      ...
      <ul class="show_box" >
                ...
                <li><a href="category.php?id=18&amp;brand=1&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.0.0">整租</a></li>
         
         
                <li><a href="category.php?id=18&amp;brand=2&amp;price_min=0&amp;price_max=0&amp;filter_attr=0.0.0">合租</a></li>
...
function show_box(this_obj,h)
{
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=18&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0.0.0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      
      <li class=""> <a href="category.php?category=18&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0.0.0&page=1&sort=shop_price&order=ASC#goods_list">租金 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <input type="hidden" name="filter_attr" value="0.0.0" />
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=18&brand=0&price_min=0&price_max=0&filter_attr=0.0.0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
