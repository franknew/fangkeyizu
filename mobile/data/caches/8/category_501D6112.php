<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:66:"/www/web/fangkeyizu/public_html/mobile/themes/default/category.dwt";i:1;s:76:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/goods_list.lbi";i:2;s:77:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1439544566;s:8:"maketime";i:1439540966;}<!DOCTYPE html>
<html>
<head>
...
<div class="search_rightChoseAll clearfix  ">
  ...
  <div class="searchRight_brand "> 
      ...
      <ul class="show_box"  >
                ...
                <li><a href="category.php?id=20&amp;brand=2&amp;price_min=3200&amp;price_max=3300&amp;filter_attr=28">3200&nbsp;-&nbsp;3300</a></li>
...
function show_box(this_obj,h)
{
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=20&display=grid&brand=2&price_min=0&price_max=0&filter_attr=28&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      
      <li class="filter-cur"> <a href="category.php?category=20&display=grid&brand=2&price_min=0&price_max=0&filter_attr=28&page=1&sort=shop_price&order=DESC#goods_list">租金 <span> <i class="f-ico-triangle-mt  f-ico-triangle-slctd"></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=20&brand=2&price_min=0&price_max=0&filter_attr=28&page=1&sort=shop_price&order=ASC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
