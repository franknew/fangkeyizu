...
function show_box(this_obj,h)
{
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=18&display=grid&brand=0&price_min=3000&price_max=4200&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      
      <li class=""> <a href="category.php?category=18&display=grid&brand=0&price_min=3000&price_max=4200&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">租金 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=18&brand=0&price_min=3000&price_max=4200&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
