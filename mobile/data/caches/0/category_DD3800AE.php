<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:66:"/www/web/fangkeyizu/public_html/mobile/themes/default/category.dwt";i:1;s:76:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/goods_list.lbi";i:2;s:77:"/www/web/fangkeyizu/public_html/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1439443204;s:8:"maketime";i:1439439604;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>合租_龙华区_所有房源_房客易租</title>
...
<div class="search_rightChoseAll clearfix  ">
  ...
  <div class="searchRight_brand "> 
		...
		<ul class="show_box" >
         <li><a href="category.php?id=18">全部</a></li>
		          <li><a href="category.php?id=19" >福田区</a></li>
         		         ...
         		         <li><span><a href="category.php?id=21" >龙华区</a></span></li>
      ...
      <ul class="show_box" >
                ...
                <li><a href="category.php?id=21&amp;brand=2&amp;price_min=0&amp;price_max=0&amp;filter_attr=58">龙华线</a> </li>
      ...
      <ul class="show_box"  >
                ...
                <li><a href="category.php?id=21&amp;brand=2&amp;price_min=1800&amp;price_max=2000">1800&nbsp;-&nbsp;2000</a></li>
         
         
                <li><a href="category.php?id=21&amp;brand=2&amp;price_min=2000&amp;price_max=2200">2000&nbsp;-&nbsp;2200</a></li>
         
         
                <li><a href="category.php?id=21&amp;brand=2&amp;price_min=2400&amp;price_max=2600">2400&nbsp;-&nbsp;2600</a></li>
      ...
      <ul class="show_box" >
                ...
                <li><a href="category.php?id=21&amp;price_min=0&amp;price_max=0">全部</a></li>
...
function show_box(this_obj,h)
{
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=21&display=grid&brand=2&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      
      <li class=""> <a href="category.php?category=21&display=grid&brand=2&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">租金 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="1800|2000">1800&nbsp;-&nbsp;2000</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="2000|2200">2000&nbsp;-&nbsp;2200</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="2400|2600">2400&nbsp;-&nbsp;2600</a></li>
                        <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=21&brand=2&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
